...
var ApplicationConfiguration = function() {
    return {
        ...
        registerModule: function(moduleName) {
            angular.module(moduleName, []), angular.module(this.applicationModuleName).requires.push(moduleName)
        }
    }
}();
angular.module(ApplicationConfiguration.applicationModuleName, ApplicationConfiguration.applicationModuleVendorDependencies), angular.module(ApplicationConfiguration.applicationModuleName).config(["$locationProvider",
...
}), ApplicationConfiguration.registerModule("articles"), ApplicationConfiguration.registerModule("core"), ApplicationConfiguration.registerModule("users"), angular.module("articles").run(["Menus",
    function(Menus) {
        Menus.addMenuItem("topbar", "Articles", "articles"), Menus.addMenuItem("topbar", "New Article", "articles/create")
    }
    ...
    function($scope, $stateParams, $location, Authentication, Articles) {
        $scope.authentication = Authentication, $scope.create = function() {
            ...
            article.updated || (article.updated = []), article.updated.push((new Date).getTime()), article.$update(function() {
    ...
    function() {
        ...
        var shouldRender = function(user) {
            if (!user) return !this.requiresAuthentication;
        ...
        this.validateMenuExistance = function(menuId) {
            ...
            return this.menus[menuId] = {
                requiresAuthentication: requiresAuthentication || !0,
            ...
            return this.validateMenuExistance(menuId), this.menus[menuId].items.push({
                ...
                requiresAuthentication: requiresAuthentication || !1,
                roles: roles || this.defaultRoles,
                shouldRender: shouldRender
            }), this.menus[menuId]
        }, this.removeMenuItem = function(menuId, menuItemURL) {
            this.validateMenuExistance(menuId);
            for (var itemIndex in this.menus[menuId].items) this.menus[menuId].items[itemIndex].menuItemURL === menuItemURL && this.menus[menuId].items.splice(itemIndex, 1);
            return this.menus[menuId]
        }, this.addMenu("topbar")
    }
