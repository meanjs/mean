...
describe('User Model Unit Tests:', function () {
  ...
  describe('Method Save', function () {
    ...
    it('should be able to show an error when trying to save without org/biz name', function (done) {
      var _user1 = new User(user1);
    ...
    it('should be able to update an existing user with valid roles without problems', function (done) {
      ...
      _user1.save(function (err) {
        should.not.exist(err);
        _user1.roles = ['Organization', 'Business'];
        _user1.save(function (err) {
          should.not.exist(err);
          _user1.remove(function (err) {
            should.not.exist(err);
