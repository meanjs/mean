(function () {
  ...
  describe('Sett ings List Controller Tests', function () {
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _SettIngsService_) {
      ...
      // Initialize the Sett ings List controller.
    ...
    describe('Instantiate', function () {
      ...
      it('should send a GET request and return all Sett ings', inject(function (SettIngsService) {
        // Set POST response
        $httpBackend.expectGET('api/sett-ings').respond(mockSettIngList);
